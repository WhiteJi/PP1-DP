...
public class MainTest {
	...
	public void testMain() {
		...
		String[] args = {"/Users/home/Dropbox/실전프로젝트1/BigData/PP1-DP","data/PP1-DP.arff"};
	...
	public void testForTasks2_1() {
		...
		String[] args = {"/Users/home/Dropbox/실전프로젝트1/BigData/source/java","data/java.arff"};
		// String[] args = {"/use/this/style/for/your/path"}; // for mac users
	...
	public void testForTasks2_2() {
		...
		// 생성이 된 후 commit/push해야 함.
		// 위 test main을 참고하여 실행하면 됨.
		String[] args = {"/Users/home/Dropbox/실전프로젝트1/BigData/source/java-1","data/java-1.arff"};
		// String[] args = {"/use/this/style/for/your/path"}; // for mac users
